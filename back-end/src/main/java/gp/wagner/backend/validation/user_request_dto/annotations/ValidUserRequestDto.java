package gp.wagner.backend.validation.user_request_dto.annotations;

import gp.wagner.backend.validation.order_request_dto.validators.OrderRequestDtoValidator;
import gp.wagner.backend.validation.user_request_dto.validators.UserRequestDtoValidator;
...
public @interface ValidUserRequestDto {
